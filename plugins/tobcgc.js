...
const anu = {
  ...
  for (let id of groups) conn.copyNForward(id, content, 'conversation',{quoted: anu, thumbnail: fs.readFileSync('./src/hisoka.jpg'), contextInfo:{externalAdReply: {title: `©HanBotz` , body: '>///<', sourceUrl: 'https://chat.whatsapp.com/IKcqBMcirblBbc9SqpKuPu', thumbnail: fs.readFileSync('./src/hisoka.jpg')}}} ,true)
